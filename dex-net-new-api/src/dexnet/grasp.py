...
class ParallelJawPtGrasp3D(PointGrasp):
    ...
    def gripper_pose(self, gripper=None):
        ...
        if USE_ALAN:
            ...
            return stf.SimilarityTransform3D(tfx.pose(R, t), from_frame='gripper', to_frame='obj')
    ...
    def perpendicular_table(self, stable_pose):
        '''
        Returns the grasp with approach_angle set appropriately to align with table normal
        '''
